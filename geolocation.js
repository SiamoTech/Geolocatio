...
function  switch_to_layer(layer_name) {
    if(layer_name == "cycle")
        layer_url = "https://tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey= la tua API KEY";
    else if(layer_name == "transport")
        layer_url = "https://tile.thunderforest.com/transport/{z}/{x}/{y}.png?apikey=la tua API KEY";
    else if(layer_name == "default")
        layer_url = "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png";
    else if(layer_name == "outdoor")
        layer_url = "https://tile.thunderforest.com/outdoors/{z}/{x}/{y}.png?apikey=la tua API KEY";    
    else if(layer_name == "landscape")
        layer_url = "https://tile.thunderforest.com/landscape/{z}/{x}/{y}.png?apikey=la tua API KEY"; 
    else if(layer_name == "spinal")
        layer_url = "https://tile.thunderforest.com/spinal-map/{z}/{x}/{y}.png?apikey=la tua API KEY"; 
    else if(layer_name == "neighbourhood")
        layer_url = "https://tile.thunderforest.com/neighbourhood/{z}/{x}/{y}.png?apikey=la tua API KEY";     
